// src/components/carRental/CarRentalMapPanel.jsx
import { View, Text, StyleSheet } from 'react-native';
import MapView, { Marker, Polyline, PROVIDER_DEFAULT } from 'react-native-maps';
import { MaterialCommunityIcons as Icon } from '@expo/vector-icons';
import { useNavigation } from '@react-navigation/native';
import { useTheme } from '@/theme';
import { DEMO_DELIVERY } from '@/screens/main/carRental/carRentalDemo';
import IconButton from '@/components/ui/IconButton';

export default function CarRentalMapPanel({
    mapRef,
    routeCoords,
    routeTarget,
    driverCoords,
    ...
    return (
        <>
            ...
            >
                ...
                <Marker coordinate={j.depotCoords} title={j.depot}>
                    <View className="marker-circle" style={[{ backgroundColor: `${primaryHex}28`, borderColor: primaryHex }]}>
                        <Icon name="warehouse" size={20} color={primaryHex} />
                    </View>
                </Marker>

                <Marker coordinate={j.renterCoords} title={j.renterName}>
                    <View className="marker-circle" style={[{ backgroundColor: `${successHex}28`, borderColor: successHex }]}>
